...
// id 选择器, 用的是   #id
let loginButton = document.querySelector('#id-button-login')
// log 出来看看
...
//
// 获得特定属性值
let user = document.querySelector('#id-input-username')
...
// 修改元素的 html 值
let msg = document.querySelector('#id-msg')
...
// [------- ajax 套路 -------]
let ajax = function(method, path, data, reseponseCallback) {
